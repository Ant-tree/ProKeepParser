...
public class ClassConstants {
    ...
    public static final String TYPE_JAVA_LANG_STRING_BUFFER = "Ljava/lang/StringBuffer;";
    public static final String NAME_JAVA_LANG_STRING_BUILDER = "java/lang/StringBuilder";
    public static final String TYPE_JAVA_LANG_STRING_BUILDER = "Ljava/lang/StringBuilder;";
