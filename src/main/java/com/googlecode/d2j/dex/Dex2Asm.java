...
public class Dex2Asm {
    ...
    public void convertClass(int dexVersion, DexClassNode classNode, ClassVisitorFactory cvf, Map<String, Clz> classes) {
        ...
        for (InnerClassNode icn : innerClassNodes) {
            if (icn.innerName != null && !isJavaIdentifier(icn.innerName)) {
                System.err.println("WARN: ignored invalid inner class name : " + icn.innerName + ", treat as anonymous inner class.");
                icn.innerName = null;
                icn.outerName = null;
            }
            icn.accept(cv);
    ...
    //private static final String HEX_CLASS_LOCATION = Hex.class.getName();
    //private static final String HEX_CLASS_LOCATION = "res/Hex";
    private static final String HEX_CLASS_LOCATION = "com/googlecode/d2j/util/Hex";
